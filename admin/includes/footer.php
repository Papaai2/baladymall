...
?>
    ...
    $admin_js_path = (isset($admin_base_for_assets) ? rtrim($admin_base_for_assets, '/') : '.') . '/js/admin_script.js';
    ?>
    <script src="<?php echo htmlspecialchars($admin_js_path); ?>?v=<?php echo time(); // Cache-busting query string ?>"></script>
