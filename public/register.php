...
if (isset($_SESSION['user_id'])) {
    // Determine redirect based on role, similar to login.php
    $redirect_url_if_already_loggedin = rtrim(SITE_URL, '/') . "/my_account.php";
    if (isset($_SESSION['role'])) {
        if ($_SESSION['role'] === 'brand_admin' && defined('BRAND_ADMIN_URL')) {
            $redirect_url_if_already_loggedin = BRAND_ADMIN_URL;
        } elseif ($_SESSION['role'] === 'brand_admin') {
             $redirect_url_if_already_loggedin = rtrim(SITE_URL, '/') . "/../brand_admin/index.php";
        } elseif ($_SESSION['role'] === 'super_admin' && defined('SUPER_ADMIN_URL')) {
        ...
        try {
            ...
            if ($existing_user) {
                ...
                $insert_stmt->execute([
                    ...
                    ':shipping_address_line1' => $shipping_address_line1, ':shipping_address_line2' => $shipping_address_line2,
                    ':shipping_city' => $shipping_city, ':shipping_governorate' => $shipping_governorate,
                ...
                header("Location: " . rtrim(SITE_URL, '/') . "/login.php?registration=success");
                exit;
            }
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" class="auth-form" novalidate>
        <fieldset>
            ...
            <div class="form-group">
                ...
                <input type="text" id="username" name="username" value="<?php echo isset($_POST['username']) ? esc_html($_POST['username']) : ''; ?>" required aria-describedby="usernameError">
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" value="<?php echo isset($_POST['email']) ? esc_html($_POST['email']) : ''; ?>" required aria-describedby="emailError">
                <?php if (isset($errors['email'])): ?><span id="emailError" class="error-text"><?php echo esc_html($errors['email']); ?></span><?php endif; ?>
            </div>

            <div class="form-group">
                <label for="phone_number">Phone Number <span class="required">*</span></label>
                <input type="tel" id="phone_number" name="phone_number" value="<?php echo isset($_POST['phone_number']) ? esc_html($_POST['phone_number']) : ''; ?>" required placeholder="+201XXXXXXXXX" aria-describedby="phoneError">
        ...
        <fieldset>
            <legend>Shipping Address</legend>
             <div class="form-group">
                ...
                <input type="text" id="first_name" name="first_name" value="<?php echo isset($_POST['first_name']) ? esc_html($_POST['first_name']) : ''; ?>" required aria-describedby="firstNameError">
             ...
             <div class="form-group">
                ...
                <input type="text" id="last_name" name="last_name" value="<?php echo isset($_POST['last_name']) ? esc_html($_POST['last_name']) : ''; ?>" required aria-describedby="lastNameError">
            ...
            <div class="form-group">
                ...
                <input type="text" id="shipping_address_line1" name="shipping_address_line1" value="<?php echo isset($_POST['shipping_address_line1']) ? esc_html($_POST['shipping_address_line1']) : ''; ?>" required aria-describedby="address1Error">
            ...
            <div class="form-group">
                ...
                <input type="text" id="shipping_address_line2" name="shipping_address_line2" value="<?php echo isset($_POST['shipping_address_line2']) ? esc_html($_POST['shipping_address_line2']) : ''; ?>">
            </div>
            <div class="form-group">
                <label for="shipping_city">City <span class="required">*</span></label>
                <input type="text" id="shipping_city" name="shipping_city" value="<?php echo isset($_POST['shipping_city']) ? esc_html($_POST['shipping_city']) : ''; ?>" required aria-describedby="cityError">
            ...
            <div class="form-group">
                ...
                <input type="text" id="shipping_governorate" name="shipping_governorate" value="<?php echo isset($_POST['shipping_governorate']) ? esc_html($_POST['shipping_governorate']) : ''; ?>" required aria-describedby="governorateError">
            ...
            <div class="form-group">
                ...
                <input type="text" id="shipping_postal_code" name="shipping_postal_code" value="<?php echo isset($_POST['shipping_postal_code']) ? esc_html($_POST['shipping_postal_code']) : ''; ?>">
            </div>
        </fieldset>
        ...
        <p class="form-switch-link">Already have an account? <a href="<?php echo rtrim(SITE_URL, '/'); ?>/login.php">Login here</a>.</p>
    </form>
</section>
