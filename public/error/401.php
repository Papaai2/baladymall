<?php
// public/error/401.php - Unauthorized
...
<head>
    ...
    <title>401 Unauthorized - <?php echo $site_name; ?></title>
    <style>
        ...
        h1 { font-size: 3em; color: #ffc107; margin-bottom: 10px; }
...
<body>
    <div class="error-container">
        ...
        <h1>401</h1>
        <h2>Unauthorized</h2>
        <p>You need to authenticate to access this resource. Please log in or verify your credentials.</p>
        <p><a href="<?php echo $site_url; ?>/login.php">Go to Login Page</a></p>
    </div>
</body>
</html>