<?php
// public/error/403.php - Forbidden
...
<head>
    ...
    <title>403 Forbidden - <?php echo $site_name; ?></title>
    <style>
...
<body>
    <div class="error-container">
        ...
        <h1>403</h1>
        <h2>Forbidden</h2>
        <p>You do not have permission to access this resource. This might be a restricted area or content.</p>
