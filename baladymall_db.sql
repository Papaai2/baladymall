...
--
-- Host: sql105.hstn.me
-- Generation Time: Jun 10, 2025 at 07:07 PM
...
--
-- Database: `if0_39200559_baladymall`
--

USE `if0_39200559_baladymall`;
...
CREATE TABLE IF NOT EXISTS `attributes` (
  ...
  `attribute_name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'e.g., Color, Size, Material',
...
ALTER TABLE `attributes`
  MODIFY `attribute_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
...
CREATE TABLE IF NOT EXISTS `attribute_values` (
  ...
  `value` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'e.g., Red, Blue, Small, Large',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
...
ALTER TABLE `attribute_values`
  MODIFY `attribute_value_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
...
CREATE TABLE IF NOT EXISTS `brands` (
  ...
  `brand_logo_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'URL path to the brand logo image',
  `brand_description` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `brand_contact_email` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `brand_contact_phone` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `brand_website_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
ALTER TABLE `brands`
  MODIFY `brand_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
...
CREATE TABLE IF NOT EXISTS `order_items` (
  ...
  `item_status` enum('pending','processing','shipped_by_brand','delivered_to_customer','cancelled','returned') COLLATE utf8mb4_unicode_ci DEFAULT 'pending' COMMENT 'Status of individual item fulfillment',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
ALTER TABLE `order_items`
  MODIFY `order_item_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `order_status` enum('pending_payment','processing','shipped','delivered','cancelled','refunded') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending_payment',
  ...
  `shipping_name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Full name for the shipment',
  `shipping_phone` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Contact phone for delivery',
  ...
  `shipping_governorate` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'e.g., Cairo, Giza, Alexandria',
  `shipping_postal_code` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shipping_country` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Egypt',
  `payment_method` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'e.g., credit_card, cash_on_delivery, fawry',
  `payment_gateway_transaction_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'For online payments',
  `notes_to_seller` text COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Customer notes for the order',
  `internal_notes` text COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Admin notes for the order (not visible to customer)',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
CREATE TABLE IF NOT EXISTS `product_images` (
  ...
  `alt_text` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'For SEO and accessibility',
...
CREATE TABLE IF NOT EXISTS `product_reviews` (
  ...
  `is_approved` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0=Pending, 1=Approved, 2=Rejected (for moderation)',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`review_id`),
  UNIQUE KEY `uk_product_user_review` (`product_id`,`user_id`) COMMENT 'One review per user per product',
...
ALTER TABLE `product_reviews`
  MODIFY `review_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
...
CREATE TABLE IF NOT EXISTS `product_variants` (
  ...
  `product_id` int(10) UNSIGNED NOT NULL COMMENT 'Foreign Key to products table',
  `variant_sku` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Optional: Stock Keeping Unit for this specific variant, unique if provided',
  ...
  `variant_image_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Optional: Specific image for this variant (e.g., the red t-shirt image)',
...
ALTER TABLE `product_variants`
  MODIFY `variant_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `main_image_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Primary display image URL for the product listing',
...
ALTER TABLE `products`
  MODIFY `product_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
...
('favicon_url', 'favicon.ico', '2025-06-10 19:07:50'),
('maintenance_mode', '0', '2025-06-10 19:07:50'),
('site_logo_url', 'uploads/site/default_logo.jpg', '2025-06-10 19:07:50'),
('site_name', 'BaladyMall', '2025-06-10 19:07:50'),
('smtp_host', 'smtp.mailersend.net', '2025-06-10 19:07:50'),
('smtp_password', 'mssp.WYEcBt0.neqvygm7eydg0p7w.R6KoBKk', '2025-06-10 19:07:50'),
('smtp_port', '587', '2025-06-10 19:07:50'),
('smtp_username', 'MS_cpcknr@baladymall.shop', '2025-06-10 19:07:50');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `password` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Stores hashed passwords',
  `email` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `first_name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `role` enum('customer','brand_admin','super_admin') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'customer',
  ...
  `shipping_governorate` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'e.g., Cairo, Giza, Alexandria',
  `shipping_postal_code` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shipping_country` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'Egypt',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`user_id`),
...
--
ALTER TABLE `brands`
  ADD CONSTRAINT `fk_brand_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON UPDATE CASCADE;

--
-- Constraints for table `categories`
--
ALTER TABLE `categories`
  ADD CONSTRAINT `fk_parent_category` FOREIGN KEY (`parent_category_id`) REFERENCES `categories` (`category_id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `order_items`
--
ALTER TABLE `order_items`
  ADD CONSTRAINT `fk_orderitem_brand` FOREIGN KEY (`brand_id`) REFERENCES `brands` (`brand_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_orderitem_order` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_orderitem_product` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`) ON UPDATE CASCADE,
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `fk_order_customer` FOREIGN KEY (`customer_id`) REFERENCES `users` (`user_id`) ON UPDATE CASCADE;
...
ALTER TABLE `product_category`
  ADD CONSTRAINT `fk_prodcat_category` FOREIGN KEY (`category_id`) REFERENCES `categories` (`category_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_prodcat_product` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `product_images`
--
ALTER TABLE `product_images`
  ADD CONSTRAINT `fk_prodimage_product` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `variant_attribute_values`
  ADD CONSTRAINT `fk_varattrval_attrval` FOREIGN KEY (`attribute_value_id`) REFERENCES `attribute_values` (`attribute_value_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_varattrval_variant` FOREIGN KEY (`variant_id`) REFERENCES `product_variants` (`variant_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
