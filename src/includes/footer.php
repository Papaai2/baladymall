...
// get_asset_url function is now defined in config.php and used for all asset/link URLs.
?>
    ...
    <?php
    $js_version = '1.0.0'; // Update this version number when script.js changes in production
    ?>
    <script src="<?php echo get_asset_url('js/script.js?v=' . $js_version); ?>"></script>
