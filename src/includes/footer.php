    ...
    <footer class="site-footer">
        <div class="container">
            <div class="footer-widgets-area">
               ...
               <?php /* <li><a href="<?php echo get_site_url_for_link('faq.php'); ?>">FAQ</a></li>
                       // Terms & Privacy links removed as per request
                        <li><a href="<?php echo get_site_url_for_link('terms.php'); ?>">Terms & Conditions</a></li>
                        <li><a href="<?php echo get_site_url_for_link('privacy.php'); ?>">Privacy Policy</a></li>
                        */ ?>
                    </ul>
                </div>
                <div class="footer-widget">
                    ...
                    <div class="social-media-links" style="margin-top: 10px;">
                        <a href="#" aria-label="Facebook" title="Follow us on Facebook" style="margin-right: 15px; display: inline-block; text-decoration:none;">
                            <?php /* Replace with actual SVG icon or font icon */ ?>
                        ...
                        <?php /* You can add more social links here following the same pattern */ ?>
                    </div>
                </div>
            </div>
