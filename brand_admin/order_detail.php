                ...
                <tbody>
                    <?php foreach ($order_items as $item): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($item['quantity'] ?? 'N/A'); ?></td> <td><?php echo htmlspecialchars($GLOBALS['currency_symbol'] ?? '') . htmlspecialchars(number_format((float)$item['subtotal_for_item'], 2)); ?></td>
                            <td>
